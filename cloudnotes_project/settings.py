...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-change-me-in-production-use-env-variable')

DEBUG = os.environ.get('DEBUG', 'True') == 'True'

ALLOWED_HOSTS = ["noteapp-alb-1464603731.ap-south-1.elb.amazonaws.com"]
